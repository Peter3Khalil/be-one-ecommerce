...
const ProductDetails = () => {
  ...
  return (
    <section className="container flex flex-col gap-8 py-10 md:flex-row md:py-16 md:*:h-[500px]">
      ...
      <div className="flex flex-col space-y-4 divide-y-2 divide-accent *:not-first:mt-auto dark:divide-y dark:divide-accent/50">
        <div className="space-y-2 pb-4">
          ...
          <p className="text-muted-foreground">
            This is a detailed description of the product. It highlights the key
            features, specifications, and benefits of the product to entice
            potential buyers.
          </p>
        </div>
        <div className="pb-4">
